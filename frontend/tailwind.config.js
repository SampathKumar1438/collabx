...
export const theme = {
    ...
    extend: {
        colors: {
            ...
            white: '#FFFFFF',
            black: '#2D2D2D', // Dark Text
            red: '#FB5454',
            'black-2': '#010101',
            body: '#4A4A4A', // Grey (Body)
            bodydark: '#AEB7C0',
            bodydark1: '#DEE4EE',
            bodydark2: '#8A99AF',
            primary: '#FFAB00', // Golden Yellow (Primary Action - from logo)
            secondary: '#F9A825', // Amber (Secondary - from logo background)
            stroke: '#E8E0D5', // Warm golden stroke
            gray: '#F5EBE0', // Light golden cream
            graydark: '#2D2D2D', // Dark Palette
            'gray-2': '#FAF5EF',
            'gray-3': '#FFF8E7',
            whiten: '#FFFBF0', // Light golden cream (Main Background)
            whiter: '#FFFDF7',
            boxdark: '#2D2D2D', // Dark Mode Panel
            'boxdark-2': '#1A1A1A', // Dark Mode Background
            strokedark: '#404040', // Dark mode border
            'form-strokedark': '#4A4A4A',
            'form-input': '#262626',
            'meta-1': '#DC3545',
            'meta-2': '#EFF2F7',
            'meta-3': '#10B981',
