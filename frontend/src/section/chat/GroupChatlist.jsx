...
import { MagnifyingGlass, Users, Plus, X, Camera, User } from "@phosphor-icons/react";
              ...
              <div className="relative group">
                <div className="flex justify-center items-center w-20 h-20 rounded-full overflow-hidden bg-gray-100 dark:bg-boxdark-2 border-2 border-stroke dark:border-strokedark">
                  <User
                    ...
                    className="w-1/2 h-1/2 dark:text-white "
                    isGroup
                  />
                </div>
                <button
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {selectedMembers.map((member) => (
                  <div
                    key={member.userId}
                    className="flex items-center gap-2 bg-primary/10 px-3 py-1.5 dark:text-white rounded-full"
                  >
                    ...
                    <button
                      ...
                      className="text-danger dark:text-white hover:text-danger/80"
                    >
                ...
                {availableUsers.map((user) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs dark:text-white text-gray-500">{user.email}</p>
                    </div>
                  </div>
                ))}
              </div>
