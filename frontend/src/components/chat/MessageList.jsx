          ...
          if (index !== -1) {
            ...
            const highlightElement = () => {
              ...
              if (element) {
                ...
                // Add highlight classes with custom logic for exact timing
                // 1. Initial State: Prepare transition opacity/background
                element.style.transition =
                  "background-color 0.3s ease-out, box-shadow 0.3s ease-out";

                // 2. Active State: Apply highlight immediately
                requestAnimationFrame(() => {
                  element.classList.add(
                    ...
                    "bg-primary/20",
                    "rounded-lg",
                    "dark:ring-offset-boxdark"
                  );
                });

                // 3. Remove Highlight: After 2500ms
                setTimeout(() => {
                  // Add fading out transition
                  element.style.transition =
                    "background-color 1s ease-in, box-shadow 1s ease-in";
                  ...
                  // Clean up style override after fade completes
                  setTimeout(() => {
                    element.style.transition = "";
                  }, 1000);
                }, 2500);
            ...
            // Try multiple times with increasing delays to allow rendering
