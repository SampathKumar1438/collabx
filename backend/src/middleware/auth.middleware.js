...
export const authenticate = async (req, res, next) => {
    try {
        ...
        // Use console directly or logger if imported, for middleware usually logger is better
        // but strict refactor here just for response consistency
        ...
        if (authHeader?.startsWith('Bearer ')) {
            ...
            if (token) {
                try {
                    ...
                    // Token invalid but auth is optional, so just continue
